...
import { Image, Pressable, ScrollView, Text, View, StatusBar } from "react-native";
...
const INGREDIENTES = [
  { id: 1, icon: <Flame size={14} color={Colors.light} />, label: "Ovos (4)", active: true },
  { id: 2, icon: <UtensilsCrossed size={14} color={Colors.primary} />, label: "Tomate (1)" },
  { id: 3, icon: <Leaf size={14} color={Colors.primary} />, label: "Cebola (1)" },
  { id: 4, icon: <Leaf size={14} color={Colors.primary} />, label: "Pimentão (1)" },
  { id: 5, icon: <Leaf size={14} color={Colors.primary} />, label: "Queijo (200g)" },
];
  ...
  return (
    <View style={styles.container}>
      ...
      <ScrollView contentContainerStyle={styles.scrollContent} showsVerticalScrollIndicator={false}>
        <Animated.Text entering={FadeInDown.delay(100)} style={styles.mainTitle}>
          O que vamos cozinhar hoje?
        </Animated.Text>
        <Animated.Text entering={FadeInDown.delay(200)} style={styles.mainSubtitle}>
        ...
        <Animated.View entering={FadeInDown.delay(600)} style={styles.btnContainer}>
        ...
        <RecipeCard delay={700} image={require("../../assets/images/omelete.png")} time="10 MIN" title="Omelete de Ervas" desc="Perfeito com seus 4 ovos." />
        <RecipeCard delay={800} image={require("../../assets/images/shakshuka.png")} time="15 MIN" title="Shakshuka" desc="Ovos cozidos em salsa de tomate." />
        <RecipeCard delay={900} image={require("../../assets/images/Pizza_marguerita.png")} time="20 MIN" title="Pizza de Marguerita" desc="Ingredientes frescos e massa leve." />
      </ScrollView>
    </View>
  );
}
...
const RecipeCard = ({ delay, image, time, title, desc }: any) => (
  <Animated.View entering={FadeInDown.delay(delay).springify()} style={styles.recipeCard}>
