      ...
      >
        ...
        <View style={styles.avatarSection}>
          <TouchableOpacity
            ...
            onPress={async () => {
              ...
              if (!res.canceled)
                setProfile({ ...profile, fotoUrl: res.assets[0].uri });
            }}
          >
            {profile.fotoUrl ? (
              <Image
          ...
          <Text style={styles.memberSince}>
            {profile.membroDesde || "Membro desde 2026"}
          </Text>
        </View>
        ...
        <View style={styles.sectionCard}>
          ...
          <InputField
            label="Nome Completo"
            value={profile.nome}
            onChange={(t) => setProfile({ ...profile, nome: t })}
          />
          <InputField
            label="E-mail"
            value={profile.email}
        ...
        <View style={styles.sectionCard}>
          ...
          <View style={styles.temporaryModeCard}>
            <View style={styles.temporaryModeHeader}>
              ...
              <View style={styles.temporaryModeHeaderText}>
                ...
                <Text style={styles.temporaryModeSubtitle}>
                  Pause restrições sem perder as configurações
                </Text>
              </View>
            </View>
            ...
            <View style={styles.segmentedControl}>
              {(
                ["always_on", "paused", "weekends_only"] as TemporaryMode[]
              ).map((m) => (
                <TouchableOpacity
                  key={m}
                  onPress={() =>
                    setPreferences({ ...preferences, temporaryMode: m })
                  }
                  style={[
            ...
            <View style={styles.lastUpdatedRow}>
              ...
              <Text style={styles.lastUpdatedValue}>
                {preferences.updatedAt || "Ainda não atualizada"}
              </Text>
            </View>
          </View>
          ...
          >
            <Text style={styles.editPreferencesText}>
              {isEditing ? "Fechar edição" : "Editar preferências"}
            </Text>
            <ChevronRight
              size={18}
              color={Colors.primary}
              style={isEditing && styles.chevronExpanded}
            />
          </TouchableOpacity>
            ...
            <View style={styles.editorContainer}>
              ...
              <View style={styles.editorSection}>
                ...
                <Text style={styles.editorHelperText}>
                  Liste outras alergias ou restrições separando cada item por
                  vírgula.
                </Text>
                <View
                  style={[
                ...
                >
                  <TextInput
                    ...
                    onChangeText={(t) =>
                      setPreferences({ ...preferences, otherRestrictions: t })
                    }
                  />
                </View>
              </View>
      ...
      {options.map((opt) => (
        <TouchableOpacity
          ...
          style={[
            ...
            selected.includes(opt.key) && styles.selectableChipActive,
          ]}
        >
          <Text
            style={[
              styles.selectableChipText,
              selected.includes(opt.key) && styles.selectableChipTextActive,
            ]}
          >
            {opt.label}
          </Text>
